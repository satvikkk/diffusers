...
try:
    ...
    _import_structure["flux"] = ["FluxPipeline", "FluxControlNetPipeline", "FluxControlNetInpaintPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .flux import FluxControlNetInpaintPipeline, FluxControlNetPipeline, FluxPipeline
